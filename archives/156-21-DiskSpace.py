...
class DiskSpace:
    def minDrives(self, used, total):
        ...
        boxes = sorted(total, reverse=True)
        used_box = 0
        for box in boxes:
            used_box += 1
            val = val - box
...
# ----- test 1 -----
p0 = [1,200,200,199,200,200]
p1 = [1000,200,200,200,200,200]
p2 = 1
all_right = KawigiEdit_RunTest(1, p0, p1, True, p2) and all_right
# ------------------

# ----- test 2 -----
p0 = [750,800,850,900,950]
p1 = [800,850,900,950,1000]
p2 = 5
all_right = KawigiEdit_RunTest(2, p0, p1, True, p2) and all_right
# ------------------

# ----- test 3 -----
p0 = [49,49,49,49,49,49,49,49,49,49,49,49,49,49,49,49,49,49,49,49,49,49,49,49,49,49,49,49,49,49,49,49,49,49,49,49,49,49,49,49,49,49,49,49,49,49,49,49,49,49]
p1 = [50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50]
p2 = 49
all_right = KawigiEdit_RunTest(3, p0, p1, True, p2) and all_right
# ------------------

# ----- test 4 -----
p0 = [331,242,384,366,428,114,145,89,381,170,329,190,482,246,2,38,220,290,402,385]
p1 = [992,509,997,946,976,873,771,565,693,714,755,878,897,789,969,727,765,521,961,906]
p2 = 6
...
# Returns:integer
# Method signature:def minDrives(self, used, total):
#
#
# CONSTRAINTS
